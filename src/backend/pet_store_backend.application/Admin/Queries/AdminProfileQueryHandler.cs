...
public class AdminProfileQueryValidator : AbstractValidator<AdminProfileQuery>
{
    public AdminProfileQueryValidator()
    {
    }
}

public class AdminProfileQueryHandler : IRequestHandler<AdminProfileQuery, ErrorOr<AdminProfileResult>>
{
    private readonly IAdminRepository _adminRepository;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public AdminProfileQueryHandler(IAdminRepository adminRepository, IHttpContextAccessor httpContextAccessor)
    {
